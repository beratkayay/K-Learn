...
struct Greetings2View: View {
    ...
    let questions = QuestionsForGreetings().questions

    var body: some View {
        VStack {
            if currentQuestionIndex < questions.count && remainingHearts > 0  {
                ZStack {
                    Color.yellow
                        .ignoresSafeArea()
                ...
                // Display failure message when remaining hearts are 0
                VStack {
