...
struct ColorsAndClothes0View: View {
    @Environment(\.presentationMode) var presentationMode: Binding<PresentationMode>
    @Environment(\.colorScheme) var colorScheme
    
    let colorsAndClothing = JapaneseColorsAndClothing.colorsAndClothing
    ...
    var body: some View {
        ZStack {
            ...
            VStack {
                ...
                List {
                    Section(header: Text("")) {
                        ForEach(colorsAndClothing) { word in
