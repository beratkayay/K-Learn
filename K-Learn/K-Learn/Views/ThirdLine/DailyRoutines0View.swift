...
struct DailyRoutines0View: View {
    @Environment(\.presentationMode) var presentationMode: Binding<PresentationMode>
    @Environment(\.colorScheme) var colorScheme
    
    let dailyRoutines = JapaneseWordsModelForDailyRoutines.dailyRoutines
...
struct DailyRoutines0View_Previews: PreviewProvider {
